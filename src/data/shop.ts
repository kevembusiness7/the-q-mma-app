...
export const products: ProdutoBase[] = [
  ...
  {
    id: 'artur-minev-art',
    slug: 'artur-minev-art',
    name: 'Artur Minev Art Shirt',
    category: 'Shirts',
    priceCents: 16900,
    badges: ['app'],
    owner: 'artur-minev',
    ...
    tags: ['UFC', 'ArturMinev', 'TheQMMA', 'Art'],
    genders: ['Men', 'Women'],
    colors: MOCKUP_COLORS,
    details: ART_SHIRT_DETAILS,
    shipping: SHIPPING,
  ...
  {
    id: 'artur-minev-cap',
    slug: 'artur-minev-cap',
    name: 'Artur Minev Art Cap',
    category: 'Caps',
    priceCents: 9900,
    badges: ['app'],
    owner: 'artur-minev',
    ...
    tags: ['UFC', 'ArturMinev', 'TheQMMA', 'Art', 'Cap'],
    genders: ['Men', 'Women'],
    colors: CAP_MOCKUP_COLORS,
    details: ART_CAP_DETAILS,
    shipping: SHIPPING,
